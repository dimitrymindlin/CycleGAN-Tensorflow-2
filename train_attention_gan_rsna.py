...
from rsna_dataloader import DataLoader

py.arg('--dataset', default='rsna')
py.arg('--datasets_dir', default='../tensorflow_datasets/downloads')
...
py.arg('--attention_type', type=str, default="attention-gan-original",
       choices=['attention-gan-foreground', 'unet', 'attention-gan-original'])
