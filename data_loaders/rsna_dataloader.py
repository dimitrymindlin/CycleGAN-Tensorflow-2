...
def get_rsna_ds_split_class(tfds_path, batch_size, crop_size, load_size, special_normalisation=None):
    ...
    """
    A_train = tfds_path + "/rsna_data/train/normal/normal"
    B_train = tfds_path + "/rsna_data/train/abnormal/abnormal"
    A_valid = tfds_path + "/rsna_data/validation/normal/normal"
    B_valid = tfds_path + "/rsna_data/validation/abnormal/abnormal"
    A_test = tfds_path + "/rsna_data/test/normal/normal"
    B_test = tfds_path + "/rsna_data/test/abnormal/abnormal"
